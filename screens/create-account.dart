...
class creataccount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        padding: EdgeInsets.fromLTRB(26*fem, 37.5*fem, 26*fem, 20*fem),
        width: double.infinity,
        ...
        child: Column(
          ...
          children: [
                  ...
                  Positioned(
                    ...
                    child: Align(
                      child: SizedBox(
                        ...
                        height: 71.38*fem,
                        child: Image.asset(
                          'assets/screens/images/urgent-bro-xPR.png',
                          width: 91.22*fem,
                          height: 71.38*fem,
                        ),
                      ),
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 119*fem, 23*fem),
              child: Text(
                'Create your account',
                style: SafeGoogleFont (
                  'Inter',
            ...
            Container(
              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 292*fem, 16*fem),
              child: Text(
                'Full Name',
                style: SafeGoogleFont (
                  'Inter',
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(21.41*fem, 19*fem, 200*fem, 19*fem),
              width: double.infinity,
              decoration: BoxDecoration (
              ...
              child: Row(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 29.41*fem, 0*fem),
                    width: 17.18*fem,
                    height: 20*fem,
                    child: Image.asset(
                      'assets/screens/images/iconsax-broken-user.png',
                      width: 17.18*fem,
                      height: 20*fem,
                    ),
                  ),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 19.99*fem,
                    child: Image.asset(
                      'assets/screens/images/iconsax-broken-usertag.png',
                      width: 18*fem,
                      height: 19.99*fem,
                    ),
                  ),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 20*fem,
                    child: Image.asset(
                      'assets/screens/images/iconsax-broken-lock1.png',
                      width: 20*fem,
                      height: 20*fem,
                    ),
                  ),
                  ...
                  Container(
                    ...
                    height: 20*fem,
                    child: Image.asset(
                      'assets/screens/images/iconsax-broken-eyeslash-1ou.png',
                      width: 20*fem,
                      height: 20*fem,
                    ),
                  ),
            ...
            Container(
              margin: EdgeInsets.fromLTRB(2*fem, 0*fem, 29*fem, 33*fem),
              width: double.infinity,
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 20*fem,
                    child: Image.asset(
                      'assets/screens/images/iconsax-broken-ticksquare.png',
                      width: 20*fem,
                      height: 20*fem,
                    ),
                  ),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 20.01*fem,
                    child: Image.asset(
                      'assets/screens/images/iconsax-broken-google.png',
                      width: 19.6*fem,
                      height: 20.01*fem,
                    ),
                  ),
